### Play minigolf, but instead  of a club, you directly add force to the ball, remotely, using a weird... loopy... magic controller???? inspired by the window manager Loop for macintosh!
